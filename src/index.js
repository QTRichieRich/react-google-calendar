...
export default class Calendar extends React.Component {
	...
	renderDates(eventsEachDay) {
		var days = [...Array(this.state.current.daysInMonth()).keys()].slice(1); // create array from 1 to number of days in month

		var dayOfWeek = this.state.current.day(); //get day of week of first day in the month

		var padDays =
			(((-this.state.current.daysInMonth() - this.state.current.day()) % 7) + 7) %
		...
		singleEvents.forEach((event) => {
			if (event.recurrence) {
				...
				dates.forEach((date) => {
					...
					this.renderSingleEvent(eventsEachDay, moment(props.startTime).date(), {
						...props,
						...eventProps,
					});
				});
		...
		return (
			...
			>
				<div className="calendar-header">
					<div className="calendar-navigate unselectable" onClick={this.lastMonth}>
						&#10094;
					</div>
					<div>
					...
					<div className="calendar-navigate unselectable" onClick={this.nextMonth}>
						&#10095;
					</div>
				</div>
				...
				{this.state.showFooter && (
					<div className="calendar-footer">
						...
						>
							<a
								href={
									'https://calendar.google.com/calendar/r?cid=' + this.props.calendarId
								}
								target="_blank"
								css={css`
									font-size: 14px;
